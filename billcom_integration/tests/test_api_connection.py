...
class TestBillcomAPIConnection(TransactionCase):
    ...
    @patch(
        "odoo.addons.billcom_integration.models.billcom_service_abstract.requests.post"
    )
    ...
    @patch(
        "odoo.addons.billcom_integration.models.billcom_service_abstract.requests.get"
    )
