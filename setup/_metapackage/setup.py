...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-account_banking_ach_direct_debit>=15.0dev,<15.1dev',
        'odoo-addon-account_banking_ach_discount>=15.0dev,<15.1dev',
        'odoo-addon-l10n_us_form_1099>=15.0dev,<15.1dev',
